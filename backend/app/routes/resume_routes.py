...
async def score_resume(
    ...
    try:
        ...
        result = calculate_resume_score(resume_text, job_description)
...
async def parse_resume(
    ...
    try:
        ...
        result = ai_parse_resume(temp_path)
...
async def check_ats_compatibility(
    ...
    try:
        ...
        result = ai_check_ats(resume_text, job_description)
...
async def full_resume_analysis(
    ...
    try:
        ...
        # Run all analyses
        parse_result = ai_parse_resume(temp_path)
        score_result = calculate_resume_score(resume_text, job_description)
        ats_result = ai_check_ats(resume_text, job_description)
        skill_gap = ai_analyze_gap(resume_text, job_description)
