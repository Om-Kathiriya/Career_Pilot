...
async def analyze_skill_gap(
    ...
    try:
        ...
        result = ai_analyze_gap(resume_text, job_description, target_role)
...
async def quick_skill_analysis(
    ...
    try:
        ...
        result = ai_analyze(request.skills)
...
async def get_skill_resources(
    ...
    try:
        ...
        resources = get_skill_learning_resources(skill)
        prerequisites = get_skill_prerequisites(skill)
